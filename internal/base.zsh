...
function osx::dependences {
    message_info "Installing dependences for ${ZSH_OSX_PACKAGE_NAME}"
    message_success "Installed dependences for ${ZSH_OSX_PACKAGE_NAME}"
}
...
function osx::packages {
    message_info "Install packages for ${ZSH_OSX_PACKAGE_NAME}"
    message_success "Installed packages for ${ZSH_OSX_PACKAGE_NAME}"
}

function osx::install {
    osx::dependences
    message_info "Installing ${ZSH_OSX_PACKAGE_NAME}"
    message_success "Installed ${ZSH_OSX_PACKAGE_NAME}"
}

function osx::post_install {
    message_info "Post Install ${ZSH_OSX_PACKAGE_NAME}"
    message_success "Success Install ${ZSH_OSX_PACKAGE_NAME}"
}
