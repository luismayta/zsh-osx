...
Contributions to zsh-osx are welcome.

Feel free to use all of the contribution options:

- Contribute to zsh-osx repositories on [GitHub](https://github.com/luismayta/zsh-osx). See [GitHub flow](./contribute/github-flow.md).
...
Documentation is a part of the zsh-osx code base. You can find the documentation files in the `doc/` subdirectory of the [main repository](https://github.com/luismayta/zsh-osx). This means that the contribution process is the same for both the source code and documentation.
...
1. See if a [Pull Request](https://github.com/luismayta/zsh-osx/pulls) exists
   - Add some comments or review the code to help it along
   - Don\'t be afraid to comment when logic needs clarification
2. Create a Fork and open a [Pull Request](https://github.com/luismayta/zsh-osx/pulls) if needed

### Code Review

- Anyone can review code
- Any [Pull Request](https://github.com/luismayta/zsh-osx/pulls) should be closed or merged within a week
