<!-- Space: Projects -->
<!-- Parent: ZshOSX -->
<!-- Title: Contributing GithubFlow ZshOSX -->
<!-- Label: ZshOSX -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-osx project on [GitHub](https://github.com/luismayta/zsh-osx), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/zsh-osx/pulls).
...
To follow the instructions in this guide and start contributing to zsh-osx project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/zsh-osx.git
```

Now your **upstream** points to **luismayta/zsh-osx**.
...
git fetch upstream # assuming upstream is luismayta/zsh-osx
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/zsh-osx/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
